...
import tk.avabin.tdg.beans.dtos.*;
...
public class ApiRestController {
    ...
    @RequestMapping("/user/checkName/{username}")
    public @ResponseBody
    ...
    @RequestMapping("/character/checkName/{name}")
    public @ResponseBody boolean checkCharacterNameInDatabase(
